...
error_code find_module_by_cmdline(IN const char* cmdline, OUT size_t* sz, OUT uint8_t** mod_bin);
...
static inline auto
acquire_tag_ptr(size_t type, aquire_tag_ptr_predicate pred) -> typed_mboottag_const_readonly_ptr<T>
{
