...
void vm::segment::init_segmentation(void)
{
    ...
    // auto local_storage = allocators::boot_allocator::bootmm_alloc();

    // memset(local_storage, 0, allocators::boot_allocator::BOOTMM_BLOCKSIZE);
    ...
    // wrmsr(0xC0000100, ((uintptr_t)local_storage) + ((allocators::boot_allocator::BOOTMM_BLOCKSIZE) / 2));
